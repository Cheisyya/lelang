      ...
      <center>
        ...
        <section class="base">
          ...
          <br><select name="status" class="form-control">
            ...
            <option value="dapat dilelang">dapat dilelang</option>
            <option value="telah selesai">telah seleesai</option>
          </select></br>

          <label>Gambar Produk</label>
            <input type="file" name="foto_barang" required="" />
          </div>
